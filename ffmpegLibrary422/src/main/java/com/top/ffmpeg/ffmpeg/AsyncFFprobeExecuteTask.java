    ...
    public void run() {
        ...
        if (completeCallback != null) {
            try {
                ...
                android.util.Log.e(FFmpegKitConfig.TAG, String.format("Exception thrown inside session complete callback.%s", ThrowableUtils.getStackTraceString(e)));
            }
        }
        ...
        if (globalFFprobeSessionCompleteCallback != null) {
            try {
                ...
                android.util.Log.e(FFmpegKitConfig.TAG, String.format("Exception thrown inside global complete callback.%s", ThrowableUtils.getStackTraceString(e)));
            }
        }
    }
