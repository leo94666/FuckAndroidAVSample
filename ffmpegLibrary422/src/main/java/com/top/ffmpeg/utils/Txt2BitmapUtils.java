...
import com.top.ffmpeglibrary422.R;
 ...
 **/
public class Txt2BitmapUtils {
    // private final static int WIDTH = DimensUtils.dip2px(ScreenUtils.getScreenWidth(ELabApplication.getApplication()));
    ...
    public static Bitmap StringListtoBitmap(Context context, ArrayList<StringBitmapParameter> AllString) {
        ...
        Bitmap bitmap = Bitmap.createBitmap(WIDTH, FontHeight * (mBreakString.size() + bNum), Bitmap.Config.ARGB_8888);
        ...
        //Bitmap  bitmap = Bitmap.createBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_transparent),0, 0, WIDTH, FontHeight * (mBreakString.size() + bNum));
