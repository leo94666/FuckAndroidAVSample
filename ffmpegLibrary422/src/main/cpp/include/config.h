...
#define FFMPEG_CONFIGURATION "--enable-libx264 --enable-gpl --enable-libfreetype --enable-libfribidi --prefix=/Users/liyang/SuperPlayer/android/output/libffmpeg --target-os=android --enable-cross-compile --enable-pic --sysroot=/Users/liyang/SuperPlayer/android/toolchain/sysroot --cross-prefix=/Users/liyang/SuperPlayer/android/toolchain/bin/arm-linux-androideabi- --arch=arm --enable-neon --enable-thumb --disable-asm --enable-inline-asm --enable-gpl --disable-version3 --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-avdevice --enable-avcodec --enable-avformat --enable-swresample --enable-swscale --enable-postproc --enable-avfilter --enable-avresample --enable-pthreads --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-videotoolbox --disable-encoders --enable-encoder=png --disable-decoders --disable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=vp6f --enable-decoder=flac --enable-decoder=hevc --enable-decoder=vp8 --enable-decoder=vp9 --disable-hwaccels --disable-muxers --enable-muxer=mp4 --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=flac --enable-demuxer=hevc --enable-demuxer=webm_dash_manifest --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=flac --enable-parser=hevc --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=concat --disable-protocol=crypto --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-linux-perf --disable-bzlib --pkg-config=/usr/local/bin/pkg-config --extra-cflags='-O3 -Wall -pipe -std=c11 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -fPIE -fPIC -I/Users/liyang/SuperPlayer/android/output/libx264/include -I/Users/liyang/SuperPlayer/android/output/libfreetype/include/freetype2 -I/Users/liyang/SuperPlayer/android/output/libfribidi/include/fribidi' --extra-ldflags=' -L/Users/liyang/SuperPlayer/android/output/libx264/lib -lx264 -L/Users/liyang/SuperPlayer/android/output/libfreetype/lib -lfreetype -L/Users/liyang/SuperPlayer/android/output/libfribidi/lib -lfribidi -Wl'"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/Users/liyang/SuperPlayer/android/output/libffmpeg/share/ffmpeg"
#define AVCONV_DATADIR "/Users/liyang/SuperPlayer/android/output/libffmpeg/share/ffmpeg"
